...
export const KundliDetails = ({ data }: { data: any }) => {
  return (
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground">Birth Date & Time</p>
                <p className="font-medium text-foreground">
                  {new Date(data.birthDateTime).toLocaleString("en-GB")}
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="font-medium text-foreground">{data.birthPlace}</p>
              </div>
            </div>
          </div>
        </div>
...
<div className="flex items-start space-x-3">
  <span className="h-5 w-5 mt-1 text-muted-foreground">⚧</span>
  <div>
